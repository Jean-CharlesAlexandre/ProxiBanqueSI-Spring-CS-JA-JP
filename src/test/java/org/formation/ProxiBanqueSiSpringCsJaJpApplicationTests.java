...
class ProxiBanqueSiSpringCsJaJpApplicationTests {
	...
	void scenario() {
		...
		CompteCourant cc1 = new CompteCourant(24154754L, "06/04/12", 543.21, cb1);
		CompteCourant cc2 = new CompteCourant(65214785L, "08/05/13", 654.32, cb2);
		CompteCourant cc3 = new CompteCourant(10235478L, "09/06/14", 765.43, cb3);
		CompteCourant cc4 = new CompteCourant(98547125L, "10/07/15", 876.54, cb4);
		CompteCourant cc5 = new CompteCourant(65214708L, "11/08/16", 987.65, cb5);

		CompteEpargne ce1 = new CompteEpargne(98563241L, "12/09/17", 1098.76);
		CompteEpargne ce2 = new CompteEpargne(20321457L, "13/10/18", 2109.87);
		CompteEpargne ce3 = new CompteEpargne(65742589L, "14/11/12", 3210.98);
		CompteEpargne ce4 = new CompteEpargne(12453658L, "15/12/13", 4321.09);
		CompteEpargne ce5 = new CompteEpargne(54632541L, "16/01/14", 5432.10);
