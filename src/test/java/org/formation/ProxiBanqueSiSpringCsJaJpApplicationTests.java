...
class ProxiBanqueSiSpringCsJaJpApplicationTests {
	...
	void scenario() {
		...
		Client cli1 = new Client("albert.einstein@fr", "0123456789", a1, "EINSTEIN", "Albert");
		cli1.setCompteCourant(cc1);
		cli1.setCompteEpargne(ce1);
		cc1.setClientAssocie(cli1);
		ce1.setClientAssocie(cli1);

		Client cli2 = new Client("antoine.lavoisier@fr", "0234567890", a2, "LAVOISIER", "Antoine");
		cli2.setCompteCourant(cc2);
		cc2.setClientAssocie(cli2);

		Client cli3 = new Client("marie.curie@fr", "0345678901", a3, "CURIE", "Marie");
		cli3.setCompteEpargne(ce2);
		ce2.setClientAssocie(cli3);

		Client cli4 = new Client("isaac.newton@fr", "0456789012", a4, "NEWTON", "Isaac");
		cli4.setCompteCourant(cc3);
		cc3.setClientAssocie(cli4);

		Client cli5 = new Client("alfred.noble@fr", "0567890123", a5, "NOBEL", "Alfred");
		cli5.setCompteEpargne(ce3);
		ce3.setClientAssocie(cli5);

		Client cli6 = new Client("google@com", "0678901234", a6, "GOOGLE");
		cli6.setCompteCourant(cc4);
		cc4.setClientAssocie(cli6);

		Client cli7 = new Client("apple@com", "0789012345", a7, "APPLE");
		cli7.setCompteEpargne(ce4);
		ce4.setClientAssocie(cli7);

		Client cli8 = new Client("amazon@com", "0890123456", a8, "AMAZON");
